...
encoder = utils_attack.Encoder(); encoder = encoder.to(device); encoder.load_state_dict(torch.load(exp_dir+'/'+f'encoder_ISSBA_2mse_2lpips_{200}.pth'))
...
for i in range(len(images_with_triggers)): 
    ...
    images_bd_G[i] = encoder(copy.deepcopy(encoded_image)) 
