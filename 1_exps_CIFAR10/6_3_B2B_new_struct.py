...
if train_B:
    ...
    utils_attack.fine_tune_ISSBA_CIFAR10_new_struct(dl_root=dl_root, model=model, label_backdoor=label_backdoor,
                                B=None, device=device, dl_te=dl_te, secret=secret, encoder=encoder_issba,
