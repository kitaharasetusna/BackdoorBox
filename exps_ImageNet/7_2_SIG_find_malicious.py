...
for idx_s in ids_suspicious[:5]:
    ...
    plt.imshow(image); plt.savefig(exp_dir+f'/step2_debug_find_sus_{idx_s}.pdf')
    ...
    plt.imshow(image_clean); plt.savefig(exp_dir+f'/step2_debug_find_clean_{idx_s}.pdf')
