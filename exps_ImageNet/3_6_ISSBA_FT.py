...
# prepare B
ds_whole_poisoned = utils_attack.CustomCIFAR10ISSBA_whole(ds_tr, ids_p, label_backdoor, secret=secret, encoder=encoder_issba, device=device)
ds_x_root = Subset(ds_tr, ids_root)
